...
public class AuthController {
  ...
  public void callback(
    ...
    LOGGER.info("TOKENS access token: {}", tokens.getAccessToken());
    LOGGER.info("TOKENS id token: {}", tokens.getIdToken());
  ...
  public String home(final Authentication authentication) {
    ...
    LOGGER.info("Input credentials: {}", token.getCredentials().toString());
    LOGGER.info("Input jwt-token: {}", jwt.getToken());
