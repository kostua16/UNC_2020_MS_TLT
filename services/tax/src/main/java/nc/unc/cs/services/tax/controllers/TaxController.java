...
public class TaxController {
  ...
  @ApiOperation(httpMethod = "GET", value = "Checking Tax Payment Status",
                nickname = "checkPaid")
  public Boolean
  checkPaid(@ApiParam(name = "taxId", type = "long", value = "Tax ID",
                      required = true) @PathVariable("taxId")
            final Long taxId) {
  ...
  @ApiOperation(httpMethod = "POST", value = "Create Tax",
  ...
  @ApiImplicitParam(
      ...
      required = true, type = "CreationTax", dataType = "CreationTax",
      dataTypeClass = CreationTax.class
      //        paramType = "body"
      )
  public Long
  createTax(@Validated @RequestBody final CreationTax createTax) {
  ...
  @PostMapping(value = "pay-tax", produces = "application/json",
               consumes = "application/json")
  @ApiOperation(httpMethod = "POST", value = "Payment of tax",
                notes = "Change in tax payment status", nickname = "payTax")
  @ApiResponses({
    @ApiResponse(code = 400, message = "Tax ID", response = Long.class)
  })
  @ApiImplicitParam(name = "taxPayment",
                    value = "An object containing tax ID and data of payment",
                    required = true, type = "TaxPayment",
                    dataType = "TaxPayment", dataTypeClass = TaxPayment.class,
                    paramType = "body")
  public ResponseEntity<Long>
  payTax(@Validated @RequestBody final TaxPayment taxPayment) {
  ...
  @PostMapping(value = "debt", produces = "application/json",
               consumes = "application/json")
  @ApiOperation(
      httpMethod = "POST", value = "A citizen is not a debtor",
  ...
  @ApiImplicitParam(
      ...
      required = true, type = "IdInfo", dataType = "IdInfo",
      dataTypeClass = IdInfo.class, paramType = "body")
  public Boolean
  isNotDebtor(@Validated @RequestBody final IdInfo idInfo) {
