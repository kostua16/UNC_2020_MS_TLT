...
public class IncorrectApartment extends PropertyAndRegistrationParentWebTest implements IncorrectDataTests {

    private static final Logger logger = LoggerFactory.getLogger(IncorrectApartment.class);

    @Test
    @Override
    public void blankData() throws Exception {
        Registration registration = this.createRegistration();
        registration.setApartment("  ");
    ...
    public void oversizeData() throws Exception {
        Registration registration = this.createRegistration();
        registration.setApartment("asdsdsdgqsr1rvxzxgadgasfasfasdasdasdasdasdasdasdasdasdasd");
