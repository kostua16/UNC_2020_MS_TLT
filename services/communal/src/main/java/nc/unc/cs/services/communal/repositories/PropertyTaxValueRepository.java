...
@Repository
public interface PropertyTaxValueRepository
    extends JpaRepository<PropertyTaxValue, Long> {

  PropertyTaxValue
  findPropertyTaxValueByPropertyTaxValueId(Long propertyTaxValueId);
