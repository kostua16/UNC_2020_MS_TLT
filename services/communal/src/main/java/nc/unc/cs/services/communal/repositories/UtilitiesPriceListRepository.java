...
@Repository
public interface UtilitiesPriceListRepository
    extends JpaRepository<UtilitiesPriceList, Long> {

  UtilitiesPriceList
  findUtilitiesPriceListByUtilitiesPriceListId(Long expenseCostId);
