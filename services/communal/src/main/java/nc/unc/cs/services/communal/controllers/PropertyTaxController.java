...
@CrossOrigin
@Api(value = "Property Tax API", description = "API for calculate Property tax and create price list")
public class PropertyTaxController {
    ...
    @GetMapping(value = "price/region", produces = "application/json")
    @ApiOperation(
        httpMethod = "GET",
        value = "Receiving PropertyTaxValue",
    ...
    public PropertyTaxValue getPropertyTaxValueByRegion(
        @ApiParam(name = "region", type = "string", value = "Region to search for PropertyTaxValue", required = true)
    ...
    @PutMapping(value = "price/{propertyTaxValueId}", consumes = "application/json", produces = "application/json")
    @ApiOperation(
        httpMethod = "PUT",
