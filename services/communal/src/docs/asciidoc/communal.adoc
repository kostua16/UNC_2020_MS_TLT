...
| Communal service
| link:/{jdocs}/nc/unc/cs/services/common/clients/tax/TaxService.html[Gibdd client]
| link:/{jdocs}/nc/unc/cs/services/communal/services/PropertyTaxService.html[Gibdd service]
