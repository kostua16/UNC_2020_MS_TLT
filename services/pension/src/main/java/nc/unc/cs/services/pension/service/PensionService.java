...
public class PensionService {
  ...
  public ResponseEntity<Pension> createPension(final Citizen citizen)
    ...
    if (age < 63) {
      // нужно выкинуть ошибку и поймать в контроллере, и через респонс ексепшн
      // отдать бэд реквест, с комментарием
      ...
      LOGGER.info("Pension card for citizen with ID = {} has been created.",
